    ...
    zh: {
      ...
      leaves: {
        ...
        our_leaves: {
          subtitle: "我们的叶子",
          intro1:
            "在Tea Alley，我们以优质的茶叶为傲，这使我们在繁忙的奶茶世界中脱颖而出。我们的茶叶直接来源于台湾的高海拔茶园，那里独特的气候和肥沃的土壤赋予了茶叶无与伦比的独特风味和香气。",
          intro2:
            "欢迎来到我们温馨的避风港——Tea Alley。在这里，传统与味道相遇。我们的心核是对质量的执着，从我们选择的茶叶开始，这些茶叶使我们的奶茶与众不同。我们自豪地展示铁观音和阿里山茶叶，这些茶叶以其卓越的风味和品质而著称。",
        },
        tea1: {
          subtitle: "铁观音茶",
          intro1:
            "铁观音是源自福建省的一种高级中国乌龙茶。它以佛教女神观音命名。这种茶以其独特复杂的生产过程而闻名，该过程包括凋萎、滚动、氧化和烘焙等精确的步骤。其结果是一种具有花香气和复杂风味的独特茶，根据发酵程度不同，风味可以从清新绿意到甜美烘烤。铁观音还因其声称的健康益处而受到高度赞赏，包括帮助消化和提供抗氧化剂。",
        },
        tea2: {
          subtitle: "阿里山茶",
          intro1:
            "阿里山茶指的是在台湾阿里山山脉种植的高品质乌龙茶。这种茶以其顺滑的花香味和奶油般的口感而闻名，这是其在独特的气候条件和高海拔地区种植的结果。阿里山茶叶通常是手工采摘并精心加工的，以增强它们细腻的香气和风味。这种茶被鉴赏家高度评价，常因其舒缓效果和微妙的甜味而受到享用。",
        },
      },
    },
  };
